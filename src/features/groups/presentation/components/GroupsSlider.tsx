...
import type { GroupsSliderProps as Props }    from '../types/groups-slider.types'
import { COVER_IMAGES }                       from '../constants/cover-images.constants'
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1 justify-between">
                    <div className="space-y-2">
                      <h3 className="text-base font-bold leading-tight tracking-tight transition-colors duration-300 group-hover:text-green-400" style={{ color: '#F4F4F5' }}>
                        {group.name}
                      </h3>
