      ...
      <div style={{ width: '100%', maxWidth: 380, margin: '0 auto' }}>
        ...
        {status === 'success' ? (
          <div role="status" aria-live="polite" style={{ textAlign: 'center', padding: '16px 0' }}>
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={C.green} strokeWidth="2.2">
                <path d="M20 6L9 17l-5-5" />
              </svg>
            </div>
            <h1 style={{ color: C.text, fontSize: 17, fontWeight: 700, margin: '0 0 8px' }}>
              Solicitud recibida
            </h1>
            <p style={{ color: C.muted, fontSize: 13, lineHeight: 1.6, margin: 0 }}>
              ...
              datos se eliminarán en un plazo máximo de{' '}
              <strong style={{ color: C.text }}>72 horas</strong>.
              Te enviaremos una confirmación al correo proporcionado.
            </p>
          </div>
        ) : (
          <>
            <h1 style={{ color: C.text, fontSize: 19, fontWeight: 700, margin: '0 0 6px', letterSpacing: '-0.02em' }}>
              Eliminar cuenta
            </h1>
            ...
            <form onSubmit={submit} noValidate>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <textarea
                  ...
                  style={{ ...inputStyle, resize: 'vertical', minHeight: 84, fontFamily: 'inherit' }}
                />
              </div>

              {error && (
                <p role="alert" style={{ color: C.red, fontSize: 12, margin: '10px 0 0' }}>
                  {error}
                </p>
              )}
              ...
              <button
                ...
                style={{
                  width: '100%', marginTop: 16, padding: '11px 16px', borderRadius: 8,
                  border: 'none', cursor: status === 'loading' ? 'default' : 'pointer',
                  backgroundColor: C.green, color: '#06210F', fontSize: 13, fontWeight: 700,
            ...
            <p style={{ color: C.faint, fontSize: 11, lineHeight: 1.6, margin: '14px 0 0', textAlign: 'center' }}>
